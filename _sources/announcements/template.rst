.. raw:: html
   ...
   <div style="text-align: center;">
       <h2>Download VAPOR</h2>
       <p>Install the latest release below. Access previous versions <a href="https://github.com/NCAR/VAPOR/releases/tag/vRELEASE_TAG">here</a>.</p>
   </div>
